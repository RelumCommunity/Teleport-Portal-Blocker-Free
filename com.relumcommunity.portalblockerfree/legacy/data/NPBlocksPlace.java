...
public class NPBlocksPlace {
	...
	public NPBlocksPlace(String string) throws ClassNotFoundException, SQLException {
	...
	public void RemoveName1(String playername, CommandSender sender) throws SQLException {
	    ...
	    String removename = lang.getString("database.netherportal.blockplace.removename");
	    ...
	    String notname = lang.getString("database.netherportal.blockplace.namenotpresent");
	...
	public void Reset(CommandSender sender) throws SQLException {
	    ...
	    String prefixs = main.getString("Prefix");
	    String prefix = prefixs.replaceAll("&", "§");
	    String resetdata = lang.getString("database.netherportal.blockplace.resetdata");
