...
public class EPBlocksPlace {
	public Connection con;
	public Statement stat;
	public EPBlocksPlace(String string) throws ClassNotFoundException, SQLException {
	...
	public void RemoveName1(String playername, CommandSender sender) throws SQLException {
		...
		String removename = lang.getString("database.endportal.blockplace.removename");
		...
		String notname = lang.getString("database.endportal.blockplace.namenotpresent");
	...
	public void Reset(CommandSender sender) throws SQLException {
	    ...
	    String prefixs = main.getString("Prefix");
	    String prefix = prefixs.replaceAll("&", "§");
	    String resetdata = lang.getString("database.endportal.blockplace.resetdata");
