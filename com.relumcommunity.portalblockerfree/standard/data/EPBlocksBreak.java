...
public class EPBlocksBreak {
	public Connection con;
	public Statement stat;
	public EPBlocksBreak(String string) throws ClassNotFoundException, SQLException {
	...
	public void RemoveName1(String playername, CommandSender sender) throws SQLException {
		...
		String removename = lang.getString("database.endportal.blockbreak.removename");
		...
		String notname = lang.getString("database.endportal.blockbreak.namenotpresent");
	...
	public void Reset(CommandSender sender) throws SQLException {
		...
		String prefixs = main.getString("Prefix");
		String prefix = prefixs.replaceAll("&", "§");
		String resetdata = lang.getString("database.endportal.blockbreak.resetdata");
